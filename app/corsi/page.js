              ...
              <div className="h-full flex items-end pb-3 sm:pb-12 md:pb-14">
                <div className="max-w-4xl w-full">
                  ...
                  <div className="flex flex-wrap items-center gap-3">
                    <span className="text-white text-sm font-bold tracking-wide backdrop-blur-sm">
                      ROMA 2026
                    </span>
                  </div>
    ...
    <div className="space-y-9">
      ...
      <section id="modulo-1" className="scroll-mt-[110px] md:scroll-mt-[140px]">
        ...
        <div className="mt-6 flex justify-end">
          <a href="#top" className="text-sm font-extrabold text-amber-700 hover:underline">
            ↑ Torna su
          </a>
        </div>
      </section>
      ...
      <section id="modulo-2" className="scroll-mt-[110px] md:scroll-mt-[140px]">
        ...
        <p className="mt-5 text-gray-700 leading-relaxed">
          Il secondo modulo entra nel cuore dell’integrazione clinica, approfondendo
          le relazioni tra apparato stomatognatico, postura e sistema nervoso.
        </p>
      ...
      <section id="modulo-3" className="scroll-mt-[110px] md:scroll-mt-[140px]">
        ...
        <p className="mt-5 text-gray-700 leading-relaxed">
          Il terzo modulo è dedicato alla gestione dei casi complessi e alla stabilità
          dei risultati nel tempo, ampliando ulteriormente la lettura clinica.
        </p>
      ...
      {/* il resto (Metodo didattico / Pratica clinica / Conclusione) lo lasci identico */}
